...
@Index("FK__Technical__Inqui__0A9D95DB", ["inquiryId"], {})
@Entity("techicaldetailsmapping", { schema: "dbo" })
export class Techicaldetailsmapping {
  ...
  @Column("varchar", { name: "Narration", nullable: true })
  ...
  @Column("varchar", { name: "DeliveryTime", nullable: true })
  deliveryTime: string | null;

  @Column("varchar", { name: "StartType", nullable: true, length: 100 })
  startType: string | null;

  @Column("int", { name: "TechDetailsListPrice", nullable: true })
  techDetailsListPrice: number | null;

  @Column("int", { name: "TechDetailsDiscount", nullable: true })
  techDetailsDiscount: number | null;
